...
public class TrangChuUser extends JFrame {
    ...
    private java.util.List<JPanel> panelDienThoaiResTimKiem;
    private JPanel panelResTimKiem;
    private JScrollPane scrollPaneResTimKiem;

    public TrangChuUser() {
        super("HỆ THỐNG CỬA HÀNG ĐIỆN THOẠI DI ĐỘNG [USER]");
    ...
    public TrangChuUser(String s, Connection connection) {
        this();
    ...
    public void initOther() {
        ...
        jLabelTenNguoiDung_TrangChu.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                jLabelTenNguoiDung_TrangChu.setIcon(new ImageIcon(TrangChuUser.class.getResource(sourceImage + "account_orange.png")));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                jLabelTenNguoiDung_TrangChu.setForeground(new Color(0, 0, 0));
                jLabelTenNguoiDung_TrangChu.setIcon(new ImageIcon(TrangChuUser.class.getResource(sourceImage + "account_default.png")));
            }
        });
            ...
            public void keyTyped(KeyEvent e) {
                if (!textFieldTimKiem.getText().equals("")) {
                    if (e.getKeyChar() == KeyEvent.VK_ENTER) {
                        ...
                        panelDienThoaiResTimKiem = new TimKiem(textFieldTimKiem.getText(), connection).getDienThoaiListTimKiem();
                        loadListResTimKiem(panelDienThoaiResTimKiem);
                        loadListResTimKiem(panelDienThoaiResTimKiem);
                        loadListResTimKiem(panelDienThoaiResTimKiem);
    ...
    public void loadListResTimKiem(java.util.List<JPanel> panelDienThoaiResTimKiem) {
        panelResTimKiem.removeAll();
        if (panelDienThoaiResTimKiem != null) {
            panelDienThoaiResTimKiem.forEach(i -> {
                i.setPreferredSize(new Dimension(204, 320));
                ((JPanel) i.getComponents()[1]).getComponents()[5].setVisible(false);
                ((JPanel) i.getComponents()[1]).getComponents()[4].setVisible(false);
    ...
    public void loadListIphone(java.util.List<JPanel> listPanelSanPham) {
        panelIPHONE_TrangChu.removeAll();
        listPanelSanPham.forEach(i -> {
            i.setPreferredSize(new Dimension(204, 320));
            ((JPanel) i.getComponents()[1]).getComponents()[5].setVisible(false);
            ((JPanel) i.getComponents()[1]).getComponents()[4].setVisible(false);
            i.getComponents()[0].addMouseListener(new MouseAdapter() {
                @Override
                public void mouseClicked(MouseEvent e) {
                    loadListIphone(listPanelSanPhamIphone.getListPanelSanPham());
                    loadListIphone(listPanelSanPhamIphone.getListPanelSanPham());
    ...
    public void loadListSamSung(java.util.List<JPanel> listPanelSanPham) {
    ...
    public void loadListOppo(java.util.List<JPanel> listPanelSanPham) {
    ...
    public void loadListXiaomi(java.util.List<JPanel> listPanelSanPham) {
    ...
    public void loadListRealme(java.util.List<JPanel> listPanelSanPham) {
