...
import com.baitaplon.script.danhsachdienthoai.DanhSachOppo;
...
public class ListPanelSanPhamOppo {
    private Connection connection;
    private PreparedStatement statement;
    private List<JPanel> listPanelSanPham;
    private DanhSachOppo danhSachOppo;

    public ListPanelSanPhamOppo(Connection connection) {
        listPanelSanPham = new ArrayList<>();
        danhSachOppo = new DanhSachOppo();
        this.connection = connection;
        loadListDienThoai();
    }

    public ListPanelSanPhamOppo(List<JPanel> listPanelSanPham) {
    ...
    public DanhSachOppo loadListDienThoai() {
        danhSachOppo.getListOppo().clear();
        listPanelSanPham.clear();
        try {
            String sql = "SELECT * FROM DienThoaiOppo";
            ...
            while (resultSet.next()) {
                ...
                panelSanPham.getLabelXoa().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        new XoaSanPham(connection, maThietBiTemp, "Oppo").setVisible(true);
                    }
                });
                panelSanPham.getLabelChinhSua().addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e) {
                        new SuaSanPham(connection, dienThoaiTemp, "Oppo").setVisible(true);
                    }
                });
                panelSanPham.getLabelAnh().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        try {
                            ...
                            String sql = "UPDATE DienThoaiOppo SET LuotXem = " + luotXemTemp + " WHERE MaThietBi = " + "'" + maThietBiTemp + "'";
    ...
    public DanhSachOppo getDanhSachOppo() {
        return danhSachOppo;
    }

    public void setDanhSachOppo(DanhSachOppo danhSachOppo) {
        this.danhSachOppo = danhSachOppo;
    }
}
