...
import com.baitaplon.script.danhsachdienthoai.DanhSachRealme;
...
public class ListPanelSanPhamRealme {
    private Connection connection;
    private PreparedStatement statement;
    private List<JPanel> listPanelSanPham;
    private DanhSachRealme danhSachRealme;

    public ListPanelSanPhamRealme(Connection connection) {
        listPanelSanPham = new ArrayList<>();
        danhSachRealme = new DanhSachRealme();
        this.connection = connection;
        loadListDienThoai();
    }

    public ListPanelSanPhamRealme(List<JPanel> listPanelSanPham) {
    ...
    public DanhSachRealme loadListDienThoai() {
        danhSachRealme.getListRealme().clear();
        listPanelSanPham.clear();
        try {
            String sql = "SELECT * FROM DienThoaiRealme";
            ...
            while (resultSet.next()) {
                ...
                panelSanPham.getLabelXoa().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        new XoaSanPham(connection, maThietBiTemp, "Realme").setVisible(true);
                    }
                });
                panelSanPham.getLabelChinhSua().addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e) {
                        new SuaSanPham(connection, dienThoaiTemp, "Realme").setVisible(true);
                    }
                });
                panelSanPham.getLabelAnh().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        try {
                            ...
                            String sql = "UPDATE DienThoaiRealme SET LuotXem = " + luotXemTemp + " WHERE MaThietBi = " + "'" + maThietBiTemp + "'";
            ...
            return danhSachRealme;
        }
    }

    public DanhSachRealme getDanhSachRealme() {
        return danhSachRealme;
    }

    public void setDanhSachRealme(DanhSachRealme danhSachRealme) {
        this.danhSachRealme = danhSachRealme;
    }
}
