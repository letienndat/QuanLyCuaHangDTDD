...
import com.baitaplon.script.danhsachdienthoai.DanhSachVivo;
...
public class ListPanelSanPhamVivo {
    private Connection connection;
    private PreparedStatement statement;
    private List<JPanel> listPanelSanPham;
    private DanhSachVivo danhSachVivo;

    public ListPanelSanPhamVivo(Connection connection) {
        listPanelSanPham = new ArrayList<>();
        danhSachVivo = new DanhSachVivo();
        this.connection = connection;
        loadListDienThoai();
    }

    public ListPanelSanPhamVivo(List<JPanel> listPanelSanPham) {
    ...
    public DanhSachVivo loadListDienThoai() {
        danhSachVivo.getListVivo().clear();
        listPanelSanPham.clear();
        try {
            String sql = "SELECT * FROM DienThoaiVivo";
            ...
            while (resultSet.next()) {
                ...
                panelSanPham.getLabelXoa().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        new XoaSanPham(connection, maThietBiTemp, "Vivo").setVisible(true);
                    }
                });
                panelSanPham.getLabelChinhSua().addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e) {
                        new SuaSanPham(connection, dienThoaiTemp, "Vivo").setVisible(true);
                    }
                });
                panelSanPham.getLabelAnh().addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        try {
                            ...
                            String sql = "UPDATE DienThoaiVivo SET LuotXem = " + luotXemTemp + " WHERE MaThietBi = " + "'" + maThietBiTemp + "'";
    ...
    public DanhSachVivo getDanhSachVivo() {
        return danhSachVivo;
    }

    public void setDanhSachVivo(DanhSachVivo danhSachVivo) {
        this.danhSachVivo = danhSachVivo;
    }
}
